...
import { Loading } from "../misc/ComponentStatuses";
...
const SignUpForm = (props) => {
    ...
    return (
        <>
            <h3 className='pb-2'>Create new account</h3>
            <Formik
                initialValues={{
                    username: '',
                    displayname: '',
            ...
            >
                {props =>
                    <Form >
                        {/*Username*/}
                        <FormGroup>
                            <div hidden={!showUserX} style={{ color: 'red', position: 'absolute' }}>Not Available</div>
